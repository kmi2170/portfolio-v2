export const data = [
  ...
  },
  {
    ...
    description: {
      en: 'A simple Web App that displays a randomly chosen Advice/Quote',
      jp: 'ランダムに選ばれたアドバイス・名言を表示するシンプルなアプリ',
    },
    features: {
      en: [
    ...
    details: {
      en: [
        'Switchable between Advice and Quote',
        'Quote can be narrowed down by categories',
        'A little addition: choose between two background images, bamboos and flowers',
      ],
      jp: [
        'アドバイス・名言の切替え',
        '名言についてはカテゴリを絞り込むことが可能。',
